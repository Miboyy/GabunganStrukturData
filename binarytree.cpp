...
int main()
{
  ...
  Node *nodeBagus, *nodeCici, *nodeDimas, *nodeErlang, *nodeFajar, *nodeGiska, *nodeHilmi;

  nodeBagus = insertLeft('B', root);
  nodeCici = insertRight('C', root);
  nodeDimas = insertLeft('D', nodeBagus);
  nodeErlang = insertRight('E', nodeBagus);
  nodeFajar = insertLeft('F', nodeCici);
  nodeGiska = insertLeft('G', nodeErlang);
  nodeHilmi = insertRight('H', nodeErlang);
//   nodeIjat = insertLeft('I', nodeGiska);
//   nodeJarjit = insertRight('J', nodeGiska);
